...
#
W = (np.random.rand(nc)-0.5) / 100.0
h = ((np.random.rand(1) - 0.5) / 100.0)[0]
YY = np.zeros(100)
XX = np.zeros(100)
EE = np.zeros(100)
...
#    plt.show(block=False)
    ...
    # key input
    print('Please input anything (q for quit)')
